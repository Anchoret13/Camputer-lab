...
ncomp = 4
sc_int=50 
checkpoint_dir='./model_8x8_learn_code_no_quantization/'
graph_dir='./graph_8x8_learn_code_no_quantization/'
...
with tf.name_scope('Dcompress_Conv'):
    outputs = tf.layers.conv2d_transpose(comp,NC,[block_size,block_size],[stride_size,stride_size], padding='VALID')
    print(outputs)
