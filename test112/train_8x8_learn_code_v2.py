...
ncomp = 4
sc_int=50 
checkpoint_dir='./model_8x8_learn_code_no_quantization_v2/'
graph_dir='./graph_8x8_learn_code_no_quantization_v2/'
...
with tf.Session() as sess:
    ...
    for i in range(global_step.eval(),num_of_iter+1):
        ...
        if i%display_step == 0:
            ...
            print("learn code v2 Iteration %d, learning rate %g, weight rate %g"%(
    ...
    code = compW.eval()
    write_hdf5(code,'code_learned_without_quantization_v2.h5')
...
with tf.Session() as sess:
    ...
    code = compW.eval()
    write_hdf5(code,'code_learned_full_network.h5')
...
write_hdf5(Co,'feature_full_network.h5')
