...
ncomp = 4
#sc_int= 20
checkpoint_dir='./model_8x8_binary_fix_code_v4/'
graph_dir='./graph_8x8_binary_fix_code_v4/'
...
with tf.name_scope('Compress_Conv_f32'):
    compf32 = tf.cast(compint,tf.float32)/8.
    print(compf32)
...
with tf.Session() as sess:
    ...
    for i in range(global_step.eval(),num_of_iter+1):
        ...
        if i%display_step == 0:
            ...
            print("bianry v4 8 Iteration %d, learning rate %g, weight rate %g"%(
