...
ncomp = 4
sc_int= 20
checkpoint_dir='./model_8x8_4bit_fix_code_v3/'
graph_dir='./graph_8x8_4bit_fix_code_v3/'
...
with tf.name_scope('Dcompress_Conv'):
    dcomp = tf.layers.conv2d_transpose(compf32,NC,[block_size,block_size],[stride_size,stride_size], padding='VALID')
    print(dcomp)
