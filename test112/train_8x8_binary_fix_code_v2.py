...
ncomp = 4
#sc_int= 20
checkpoint_dir='./model_8x8_binary_fix_code_v2/'
graph_dir='./graph_8x8_binary_fix_code_v2/'
...
with tf.Session() as sess:
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        print('Loading....................')
        test_loss = Loss.eval(feed_dict={Data_train:x_train[0:10,:,:,:]})
    ...
    for i in range(global_step.eval(),num_of_iter+1):
        ...
        if i%display_step == 0:
            ...
            test_loss = Loss.eval(feed_dict={Data_train:x_test[0:10,:,:,:]})
            train_psnr = Psnr.eval(feed_dict={Data_train:x_train[a,:,:,:]})
            test_psnr = Psnr.eval(feed_dict={Data_train:x_test[0:10,:,:,:]})
