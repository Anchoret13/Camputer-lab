...
ncomp = 4
sc_int=10000.
checkpoint_dir='./model_8x8_zeros/'
graph_dir='./graph_8x8_zeros/'
...
compW = tf.get_variable("comp_W", [block_size, block_size, NC, ncomp], initializer=tf.keras.initializers.Zeros)
print("compW: \n" + str(compW))
